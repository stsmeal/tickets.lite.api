...
var MongoDBClient = (function () {
    ...
    MongoDBClient.prototype.findAsync = function (collection, filter) {
    ...
    MongoDBClient.prototype.findOne = function (collection, filter, result) {
        this.db.collection(collection).find(filter).toArray(function (error, find) {
            return result(error, find);
        });
    };
    MongoDBClient.prototype.findOneAsync = function (collection, filter) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
                        _this.db.collection(collection).find(filter).limit(1).toArray(function (error, find) {
                            if (error) {
                                reject(error);
                            }
                            else {
    ...
    MongoDBClient.prototype.findOneByIdAsync = function (collection, objectId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
    ...
    MongoDBClient.prototype.insertAsync = function (collection, model) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) {
